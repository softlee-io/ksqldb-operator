...
// KsqldbClusterReconciler reconciles a KsqldbCluster object
type KsqldbClusterReconciler struct {
	client.Client
...
// the KsqldbCluster object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.13.0/pkg/reconcile
func (r *KsqldbClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *KsqldbClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
